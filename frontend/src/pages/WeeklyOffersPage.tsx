    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-[#992A16] to-[#be3c25] text-white py-12 lg:py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-base lg:text-lg mb-8 opacity-80 max-w-2xl mx-auto">
            Only this week. Don't miss out on our exclusive selection of premium organic products at unbeatable prices!
          </p>
          <button
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 lg:py-20">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Handpicked products just for this week</p>
        </div>
      ...
      <section className="bg-[#f8f6f2] py-12 lg:py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
            These exclusive weekly offers are available for a limited time only. Stock is limited, so shop now!
          </p>
          <button
