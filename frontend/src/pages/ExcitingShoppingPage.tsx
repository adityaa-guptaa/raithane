    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-[#992A16] to-[#be3c25] text-white py-12 lg:py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-base lg:text-lg mb-8 opacity-80 max-w-2xl mx-auto">
            Feed your family the best with our exciting collection of fresh and organic products!
          </p>
          <button
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 lg:py-20">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Browse our exciting collection of fresh products</p>
        </div>
      ...
      <section className="bg-[#f8f6f2] py-12 lg:py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl lg:text-5xl font-bold text-[#2f1f4a] mb-6">
            Make Your Grocery Shopping Fun!
          </h2>
          <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
            Discover fresh, organic, and exciting products for your family. Feed them the best every day!
          </p>
          <button
...
export default ExcitingShoppingPage;
